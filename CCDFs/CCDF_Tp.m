...
%Tp = 10s
H_A1_blockageA1 = H_A1.*(1-0);
H_A1_blockageB1 = H_A2.*(1-0.056);
H_A1_blockageC1 = H_A3.*(1-0.112-0.050);
H_A1_blockageD1 = H_A4.*(1- 0.012);

%Tp = 50s
H_A1_blockageA2 = H_A1.*(1-0);
H_A1_blockageB2 = H_A2.*(1-0.158);
H_A1_blockageC2 = H_A3.*(1-0.209);
H_A1_blockageD2 = H_A4.*(1- 0.027);

%Tp = 100s
H_A1_blockageA3 = H_A1.*(1-0.149);
H_A1_blockageB3 = H_A2.*(1-0.195-0.093);
H_A1_blockageC3 = H_A3.*(1-0.120);
H_A1_blockageD3 = H_A4.*(1- 0.128 - 0.083);
...
legend('T_p = 10s', 'T_p = 50s', 'T_p = 100s');
title('CCDF of average received power for blockages = 2');
